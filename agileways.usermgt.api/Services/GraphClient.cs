...
namespace agileways.usermgt.api.Services
{
    public class GraphClient : IGraphClient
    {
        ...
        public async Task<IEnumerable<Shared.DirectoryObjects.User>> GetUsers()
        {
            ...
            return users.Select(u => new Shared.DirectoryObjects.User
            {
                Id = u.Id,
                ...
                CompanyId = u.AdditionalData?.ContainsKey($"extension_{extId}_companyId") == true ?
                                (string)u.AdditionalData[$"extension_{extId}_companyId"] :
                                "EMPTY"
            });
        }
        ...
        public async Task<IEnumerable<Role>> GetUserAssignedRolesForApplicationByClientId(string clientId, string userId)
        {
        ...
        public async Task<IEnumerable<Shared.DirectoryObjects.User>> GetUsersForCompanyAsync(string companyId = "")
        {
            var extId = "fe49ff62ac584ec39706452de6fb7fe7";
